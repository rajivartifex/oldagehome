                ...
                <div class="col-lg-7 mx-auto text-center align-self-center">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="feature">
                                <span class="img-wrap">
                                    <img src="{{ asset('assets/images/svg/svg/006-elderly-3.svg') }}" alt="Image"
                                        class="img-fluid">
                                </span>
                        ...
                        <div class="col-lg-4">
                            <div class="feature">
                                <span class="img-wrap">
                                    <img src="{{ asset('assets/images/svg/svg/005-elderly-2.svg') }}" alt="Image"
                                        class="img-fluid">
                                </span>
                                <h3>Expert Nursing Staff</h3>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="feature">
                                <span class="img-wrap">
                                    <img src="{{ asset('assets/images/svg/svg/004-nurse.svg') }}" alt="Image"
                                        class="img-fluid">
                                </span>
                                <h3>Expert Nursing Staff</h3>
                            </div>

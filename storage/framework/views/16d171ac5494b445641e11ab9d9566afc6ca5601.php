<?php $__env->startSection('content'); ?>
    <div class="slide-item overlay" style="background-image: url(<?php echo e(asset('assets/images/slider-1.jpg')); ?>)">
        <div class="container">
            <div class="row">
        ...
        <div class="d-lg-flex align-items-center w-100">
            <div class="d-flex pagination-item  h-100">
                <span class="icon-wrap">
                    <img src="<?php echo e(asset('assets/images/svg/svg/001-elderly.svg')); ?>" alt="Image" class="img-fluid">
                </span>
                <div>
            ...
            <div class="d-flex pagination-item h-100">
                <span class="icon-wrap">
                    <img src="<?php echo e(asset('assets/images/svg/svg/002-elderly-1.svg')); ?>" alt="Image" class="img-fluid">
                </span>
                <div>
                    <span class="subheading">Try Our Services</span>
            ...
            <div class="d-flex pagination-item h-100">
                <span class="icon-wrap">
                    <img src="<?php echo e(asset('assets/images/svg/svg/003-rocking-chair.svg')); ?>" alt="Image" class="img-fluid">
                </span>
                <div>
                    <span class="subheading">Try Our Services</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="service">
                        <a href="#" class="d-block"><img src="<?php echo e(asset('assets/images/img_4_sq.jpg')); ?>"
                ...
                <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="service">
                        <a href="#" class="d-block"><img src="<?php echo e(asset('assets/images/img_1_sq.jpg')); ?>"
                                alt="Image" class="img-fluid"></a>
                        <div class="service-inner">
                            <h3>Special Care</h3>
                            <p>Lorem ipsum dolor sit amet elit.</p>
                ...
                <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="service">
                        <a href="#" class="d-block"><img src="<?php echo e(asset('assets/images/img_2_sq.jpg')); ?>"
                                alt="Image" class="img-fluid"></a>
                        <div class="service-inner">
                            <h3>Special Care</h3>
                            <p>Lorem ipsum dolor sit amet elit.</p>
                ...
                <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="service">
                        <a href="#" class="d-block"><img src="<?php echo e(asset('assets/images/img_3_sq.jpg')); ?>"
                                alt="Image" class="img-fluid"></a>
                        <div class="service-inner">
                            <h3>Special Care</h3>
                            <p>Lorem ipsum dolor sit amet elit.</p>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-7">
                    <div class="section-heading">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="<?php echo e(asset('assets/images/img_3.jpg')); ?>" alt="Image" class="img-fluid">
                            </div>
                            <div class="col-lg-6">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="d-block custom-media algin-items-stretch">
                        ...
                        <div class="img-bg" style="background-image: url(<?php echo e(asset('assets/images/img_2.jpg')); ?>)"></div>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="cover overlay" style="background-image: url(<?php echo e(asset('assets/images/slider-2.jpg')); ?>)">
        <div class="container">
            <div class="row ">
                <div class="col-lg-7 mx-auto text-center align-self-center">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="feature">
                                <span class="img-wrap">
                                    <img src="<?php echo e(asset('assets/images/svg/svg/006-elderly-3.svg')); ?>" alt="Image"
                                        class="img-fluid">
                                </span>
                        ...
                        <div class="col-lg-4">
                            <div class="feature">
                                <span class="img-wrap">
                                    <img src="<?php echo e(asset('assets/images/svg/svg/005-elderly-2.svg')); ?>" alt="Image"
                                        class="img-fluid">
                                </span>
                                <h3>Expert Nursing Staff</h3>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="feature">
                                <span class="img-wrap">
                                    <img src="<?php echo e(asset('assets/images/svg/svg/004-nurse.svg')); ?>" alt="Image"
                                        class="img-fluid">
                                </span>
                                <h3>Expert Nursing Staff</h3>
                            </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
                    <div class="testimonial text-center">
                        <img src="<?php echo e(asset('assets/images/person_1.jpg')); ?>" alt="Image" class="img-fluid">
                        <blockquote>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="d-block d-flex custom-media algin-items-stretch">
                        ...
                        <div class="img-bg" style="background-image: url(<?php echo e(asset('assets/images/img_3.jpg')); ?>)"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="blog-entry">
                        <a href="#" class="d-block">
                            <img src="<?php echo e(asset('assets/images/img_1.jpg')); ?>" alt="Image" class="img-fluid">
                        </a>
                ...
                <div class="col-md-4">
                    <div class="blog-entry">
                        <a href="#" class="d-block">
                            <img src="<?php echo e(asset('assets/images/img_2.jpg')); ?>" alt="Image" class="img-fluid">
                        </a>
                        <div class="post-meta d-flex justify-content-center">
                            <span>
                                <span class="icon-calendar"></span>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oldagehome-main\oldagehome-main\resources\views/pages/index.blade.php ENDPATH**/ ?>
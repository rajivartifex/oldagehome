            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="<?php echo e(route('service-manage','new')); ?>" class="btn btn-sm btn-primary">Add Service</a>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(route('service-manage',$service->id ?? 0)); ?>" class="btn btn-sm btn-success">Edit</a></td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oldagehome\resources\views/admin/pages/services/servicelist.blade.php ENDPATH**/ ?>